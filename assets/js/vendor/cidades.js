$(function () {
    ...
    $('#form-cep').on('focusout', function () {
        $.ajax({
            ...
            success: function (resposta) {
                ...
                $('#form-estado').val(resposta.estado)
                $('#form-numero').focus()

                // Desabilita os campos de cidade e estado após o preenchimento com sucesso
                $(
                    '#form-cidade, #form-estado, #form-bairro, #form-endereco'
                ).each(function () {
    ...
    // Updates city options when a state is selected
    $('#form-select-estado').on('change', function () {
        let estadoSelecionado = $(this).val()

        $('#form-select-cidade').html(
            $('<option>', {
                value: '',
        ...
        $(lista.estados).each(function (index, estado) {
            if (estado.nome === estadoSelecionado) {
                $(estado.cidades).each(function (key, cidade) {
                    $('#form-select-cidade').append(
                        $('<option>', {
                            value: cidade,
                            text: cidade,
                        })
